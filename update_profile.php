...
<head>
    ...
    <title>Pastries First | Update Profile</title>
...
<br><br><br><br><br><br>
<i class="fa-solid fa-arrow-left"><input
...
/></i>
   <form action="" method="post">
      ...
      <input type="number" name="number" placeholder="<?= $fetch_profile['number']; ?>" class="box" min="0" maxlength="11">
