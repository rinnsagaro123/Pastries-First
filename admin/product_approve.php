...
if(isset($_POST['update_payment'])){
   ...
   $update_status = $conn->prepare("UPDATE `orders` SET order_number = ?, admin_id = ? WHERE user_id = ?");
   $update_status->execute([$order_id, $admin_id, $user_id]);  
...
<section class="placed-orders">
    <h1 class="heading">Orders to Approve</h1>
...
<div class="box">
      ...
      <form action=" " method="POST">
         ...
         <input type="hidden" name="payment_status_to_ship" value="Transit">
         <input type="hidden" name="notify" value="Your order is in-transit">
